...
api_secret = 'EkjSgtZbVZ3pg3h5rpKMg7WQguAkX6Qq2Vqc2nLne7yoizCUtoaNTXtK14diiYOg'

# Program supports BNB, BTC, and ETH markets only. No USDT.
from pythonbinance.binance.client import Client
from pythonbinance.binance.enums import *
from pythonbinance.binance.exceptions import BinanceAPIException
